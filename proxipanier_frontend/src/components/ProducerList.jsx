...
function ProducerList() {
    ...
    return (
        <div className="flex flex-col items-center mt-20">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 w-full max-w-5xl rounded-lg overflow-hidden">
                {filteredProducers.length > 0 ? (
                        ...
                        return (
                            ...
                            >
                                <div className="card-body">
                                    ...
                                    <br />
                                    <p className="text-white">Ville: {user.city || 'Non spécifiée'}</p>
                    ...
                    <p className="text-white">Aucun producteur disponible dans un rayon de {distanceLimit} km.</p>
                )}
            </div>
        </div>
    );
